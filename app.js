...
const dbYarnTestRouter = require("./routes/dbYarnTest_router");
const dbPatternTestRouter = require("./routes/dbPatternTest_router");
...
const safesitelist = ["https://www.fro99y.shop","http://www.fro99y.shop","https://fro99y.ga","http://fro99y.ga", "https://froggy-34371.web.app", "http://localhost:8100"];
const corsOptions = {
